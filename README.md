...
| 🧊 **丐** | **JA-02** | 约 135 元 | 清音/过载双通道，可调音色增益，支持耳机、蓝牙伴奏和伴奏音量调节 |
| ⚖️ **标配** | **JAM BUDDY** | 约 350 元 | 三通道，支持音量音色调节、增益调节、延迟效果、蓝牙伴奏，支持信号输出或转接到监听耳机 |
| 🚀 **顶** | **JAM BUDDY II** | 约 550 元 | 三通道，支持音量、三段均衡和增益调节，支持多种效果（混响、延迟、调制）、箱头模拟、有线及蓝牙伴奏、蓝牙伴奏音量调节、内录、调音器、鼓机、Looper、监听耳机、信号输出 |
| 🌌 **顶中顶** | - | - | 那你穷玩什么摇滚 |
